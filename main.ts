...
async function main(){
    ...
    const myKeypair = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
    const mint = new web3.PublicKey("3ogp9TejsPaLFjBVUWba5AzgaZ8Vpu9qs9VKKBb7hD38");
    ...
    const ourMetadata = { // TODO change those values!
        name: "Geeks", 
        symbol: "GRT",
        uri: "https://github.com/aquib20034/solana-token-2022/blob/main/metadata.json",
    }
    if(INITIALIZE){
        const onChainData = {
            ...ourMetadata,
